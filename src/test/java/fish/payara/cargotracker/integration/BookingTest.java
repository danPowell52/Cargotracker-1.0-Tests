...
public class BookingTest {
    ...
    public void testBookNewCargo() {
        ...
        try {
            ...
            System.out.println("WUB"+ deploymentUrl);
            System.out.println("WUB"+ deploymentUrl);
    ...
    public void testAdminTrackNewCargo() {
        ...
        log.log(Level.INFO, "Starting automated test to track Id \"" + newCargoId + "\" through admin interface.");
        try {
            System.out.println(landingPageResponse.getUrl());
    ...
    public void testViewDetailsNewCargo() {
        ...
        try {
            ...
            log.log(Level.INFO, detailsPage.asText());
